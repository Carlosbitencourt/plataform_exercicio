...
exports.createAbacateBilling = (0, https_1.onCall)({
    ...
    if (!name || !email || !amount) {
        ...
        throw new https_1.HttpsError("invalid-argument", `Dados insuficientes para gerar faturamento. Recebido: name=${name}, email=${email}, amount=${amount}`);
    }
    ...
    try {
        ...
        const v1Result = await v1Response.json().catch(() => ({}));
    ...
    try {
        ...
        const v2Result = await v2Response.json().catch(() => ({}));
        ...
        throw new https_1.HttpsError("internal", "Falha interna ao comunicar com portal AbacatePay.");
    }
});
