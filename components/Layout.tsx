...
const Layout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  return (
    <div className="flex min-h-screen bg-slate-100 text-slate-900 font-sans">
      ...
      <aside className="w-64 bg-black flex-shrink-0 flex flex-col z-20 shadow-[10px_0_30px_rgba(0,0,0,0.2)]">
        <div className="p-8">
          <div className="flex items-center gap-2 group cursor-pointer">
            ...
            <h1 className="text-2xl font-black italic tracking-tighter text-white font-sport uppercase">
      ...
      <main className="flex-1 overflow-y-auto flex flex-col">
        <header className="bg-white border-b-2 border-slate-300 py-6 px-10 flex justify-between items-center sticky top-0 z-10 shadow-sm">
